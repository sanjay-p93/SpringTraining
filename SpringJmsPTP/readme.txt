...
2 Application a producer to publish messages to a queue and a Receiver listen to read from the queue implemented  using JmsTemplate and Apache ActiveMQ broker
