...
Consists of 2 Application a publisher to publish messages to a tapic and a Subscriber with multiple listener to read from the same topic implemented  using JmsTemplate and Apache ActiveMQ broker
